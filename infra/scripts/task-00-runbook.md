...
2. Criar as 5 roles conforme [github-pipeline-setup.md](../../docs/foundation/github-pipeline-setup.md) (seção 3) ou outputs do template abaixo
...
## 5. CDK bootstrap — **não nesta task**
